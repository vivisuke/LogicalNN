...
func teacher_value(ope, inp:Array):
	if ope == OP_AND: return 1.0 if inp[0] > 0 && inp[1] > 0.0 else -1.0		# AND
	elif ope == OP_OR: return 1.0 if inp[0] > 0 || inp[1] > 0.0 else -1.0		# OR
	elif ope == OP_NAND: return -1.0 if inp[0] > 0 && inp[1] > 0.0 else 1.0		# NAND
	elif ope == OP_NOR: return -1.0 if inp[0] > 0 || inp[1] > 0.0 else 1.0		# NOR
